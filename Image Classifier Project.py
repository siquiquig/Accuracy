...
data_transforms = {
   'training' : transforms.Compose([transforms.RandomResizedCrop(224), transforms.RandomRotation(30),
   ...
   'validation' : transforms.Compose([transforms.Resize(224), transforms.CenterCrop(224),
                                        transforms.ToTensor(),
                                        transforms.Normalize([0.485, 0.456, 0.406],
                                                             [0.229, 0.224, 0.225])]),
      
   'testing' : transforms.Compose ([transforms.Resize(224), transforms.CenterCrop(224),
                                      transforms.ToTensor(),
                                      transforms.Normalize([0.485, 0.456, 0.406],
                                                           [0.229, 0.224, 0.225])])
...
# Using generators and iterator to split out images one at  atime
...
# Training our classifier using backpropagation method in pretrained network to get features 
# Tracking loss and accuracy to determine best hyper parameters
    ...
    for mode in [training_mode, validation_mode]:
        ...
        for data in dataloaders[mode]:
            ...
            with  torch.no_grad():
                ...
                accuracy = equality.type(torch.float)
